    ...
    <div class="row bg-secondary py-1 px-xl-5">
        ...
        <div class="col-lg-6 text-center text-lg-right">
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">User
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="/edit-user-view" class="dropdown-item" type="button">Edit</a>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${page.getContent()}" var="sp">
                <tr>
                    ...
                    <td>${sp.donGia} VND</td>
                    <td>
                        <a href="/cart/add-tai-nghe/${sp.taiNgheId}" class="btn btn-primary">Add to Cart</a>
                        <a href="/ASM/quan-ly-tai-nghe/detail/${sp.taiNgheId}" class="btn btn-primary">Detail</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
