        ...
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <c:forEach items="${cart}" var="c">
                    <tr>
                        <td class="align-middle">${c.tenTaiNghe}</td>
                        <td class="align-middle">${c.donGia}</td>
                        <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                <div class="input-group-btn">
                                    <a href="/cart/giamSoLuong/${c.taiNgheId}" class="btn btn-sm btn-primary btn-minus">
                                        <i class="fa fa-minus"></i>
                                    </a>
                                </div>
                                <input type="text"
                                       class="form-control form-control-sm bg-secondary border-0 text-center"
                                       value="${DSSP[c.taiNgheId]}">
                                <div class="input-group-btn">
                                    <a href="/cart/tangSoLuong/${c.taiNgheId}" class="btn btn-sm btn-primary btn-plus">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </div>
                            </div>
                        </td>
                        <td class="align-middle">${c.donGia*DSSP[c.taiNgheId]}</td>
                        <td class="align-middle">
                            <a href="/cart/xoaTaiNghe/${c.taiNgheId}" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <div class="bg-light p-30 mb-5">
                ...
                <div class="pt-2">
                    <div class="d-flex justify-content-between mt-2">
                        <h5>Total</h5>
                        <h5>${tongTien + 30000} VND</h5>
                    </div>
                    <a href="">
                        <button class="btn btn-block btn-primary font-weight-bold my-3 py-3">Xác nhận thanh toán
                        </button>
                    </a>
                </div>
            </div>
